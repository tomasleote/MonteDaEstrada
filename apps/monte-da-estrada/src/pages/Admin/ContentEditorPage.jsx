...
const ContentEditorPage = () => {
  ...
  const [redondezas, setRedondezas] = useState(redondezasData);
  ...
  const tabs = [
    ...
    { id: 'redondezas', label: 'Redondezas', icon: '🗺️' },
  ...
  return (
    <div className={styles.editorPage}>
      ...
      <div className={styles.content}>
        ...
        {activeTab === 'redondezas' && (
          <RedondezasEditor redondezas={redondezas} updateValue={(path, value) => updateValue(setRedondezas, path, value)} />
        )}
...
// Redondezas Page Editor Component
const RedondezasEditor = ({ redondezas, updateValue }) => (
  <div className={styles.editorSection}>
    <h2>Página das Redondezas</h2>
