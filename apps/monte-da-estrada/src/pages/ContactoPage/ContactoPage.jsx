...
const contactCopy = {
  pt: {
    ...
    contactIntro: 'Respondemos a todas as mensagens com a maior brevidade possível. Para reservas, o nosso website garante o melhor preço. Estamos disponíveis também no WhatsApp.',
  ...
  en: {
    ...
    contactIntro: 'We respond to all messages as soon as possible. For reservations, our website guarantees the best price. We are also available on WhatsApp.',
    mapEyebrow: 'Location',
    mapHeading: 'Find us.',
